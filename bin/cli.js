...
/**
 * HeartSync - Selfie Skill Installer for OpenClaw
 *
...
const SKILL_NAME = "heartsync-selfie";
...
function printBanner() {
  console.log(`
${c("magenta", "┌─────────────────────────────────────────┐")}
${c("magenta", "│")}  ${c("bright", "HeartSync Selfie")} - OpenClaw Skill Installer ${c("magenta", "│")}
${c("magenta", "└─────────────────────────────────────────┘")}
...
async function checkPrerequisites() {
  ...
  if (fs.existsSync(SKILL_DEST)) {
    logWarn("HeartSync Selfie is already installed!");
...
- **Emoji:** ❤️
- **Avatar:** https://cdn.jsdelivr.net/gh/soulomonlab/heartsync@main/assets/boy-main.png
`;
...
`;
  ...
  if (currentSoul.includes("HeartSync Selfie")) {
    ...
    const cleaned = currentSoul.replace(
      /\n## HeartSync Selfie Capability[\s\S]*?(?=\n## |\n# |$)/,
      ""
    );
...
function printSummary() {
  ...
  console.log(`
${c("green", "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")}
${c("bright", "  HeartSync Selfie is ready!")}
${c("green", "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")}
